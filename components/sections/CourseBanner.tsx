        ...
        >
          ...
          <div className="flex-1">
            <h3 className="text-base font-bold text-charcoal">
              The Signal Method — Free 5-Day Email Course
            </h3>
            <p className="mt-1 text-sm text-slate">
              Learn the five things your website needs to convert visitors into
              customers. One lesson per day, zero fluff.
            </p>
          </div>
      ...
      >
        ...
        <div className="flex-1">
          ...
          <h3 className="text-lg font-bold text-charcoal md:text-xl">
            The Signal Method — 5 lessons that change how you think about your
            website
          </h3>
          <p className="mt-2 max-w-[55ch] text-[0.9rem] leading-[1.7] text-slate">
            Over five days, learn the five elements every business website needs
            to convert visitors into customers. One lesson per day, practical
