...
export const runInsightGeneration = internalAction({
    ...
    handler: async (ctx, args) => {
        const data = await ctx.runQuery(internal.signalInsights.getReportsForInsight, { insightId: args.insightId });
        if (!data) {
            console.error("runInsightGeneration: insight not found", args.insightId);
            return;
        }
