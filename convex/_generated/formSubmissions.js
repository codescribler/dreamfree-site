...
export const list = query({
    args: {
        type: v.optional(v.union(v.literal("course_signup"), v.literal("email_capture"), v.literal("contact_form"), v.literal("signal_score"), v.literal("content_idea_generator"), v.literal("demo_request"))),
        limit: v.optional(v.number()),
    },
    handler: async (ctx, args) => {
        const limit = args.limit ?? 50;
